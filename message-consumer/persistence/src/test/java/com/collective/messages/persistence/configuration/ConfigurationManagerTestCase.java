...
public class ConfigurationManagerTestCase {
    ...
    public void testConfiguration() {
        MessagesPersistenceConfiguration messagesPersistenceConfiguration =
                configurationManager.getMessagesPersistenceConfiguration();
        Assert.assertNotNull(messagesPersistenceConfiguration);
        //check database name is correct
        Assert.assertTrue(messagesPersistenceConfiguration.getProperties()
                .getProperty("url").endsWith("collective-messages"));
    }
}
