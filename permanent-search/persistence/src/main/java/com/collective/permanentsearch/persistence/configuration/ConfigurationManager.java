...
public class ConfigurationManager {
    ...
    private PermanentSearchPersistenceConfiguration permanentSearchPersistenceConfiguration;
    ...
    private ConfigurationManager(String configurationFilePath) {
        ...
        initPermanentSearchPersistenceConfiguration();
    }
    ...
    private void initPermanentSearchPersistenceConfiguration() {
        ...
        permanentSearchPersistenceConfiguration =
                new PermanentSearchPersistenceConfiguration(host, port, db, username, password);
    }

    public PermanentSearchPersistenceConfiguration getPermanentSearchPersistenceConfiguration() {
        return permanentSearchPersistenceConfiguration;
    }
}
