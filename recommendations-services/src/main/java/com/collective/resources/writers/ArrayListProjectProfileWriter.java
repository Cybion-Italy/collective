...
public class ArrayListProjectProfileWriter
        implements MessageBodyWriter<ArrayList<ProjectProfile>> {
    ...
    public long getSize(ArrayList<ProjectProfile> projectProfiles,
                        Class<?> aClass, Type type, Annotation[] annotations,
                        MediaType mediaType) {
        return -1;
    }

    public void writeTo(ArrayList<ProjectProfile> projectProfiles,
                        Class<?> aClass, Type type, Annotation[] annotations,
                        MediaType mediaType,
