 ...
 * {@link com.collective.profiler.line.ProfilingLineItem}s.
 *
 * Each {@link com.collective.profiler.line.ProfilingLineItem} added
 * to the {@link com.collective.profiler.line.ProfilingLine} must respect
 * the object type returned by the previous {@link com.collective.profiler.line.ProfilingLineItem}.
 *
...
public abstract class ProfilingLine {
    ...
    /**
     * Runs the whole line calling the {@link com.collective.profiler.line.ProfilingLineItem}
     * registered chain.
     *
     * @param profilingInput the {@link com.collective.profiler.line.ProfilingInput} to be processed.
     * @return a not <i>null</i> {@link com.collective.profiler.line.ProfilingResult} .
